...
fun JanitorNameNumber(
    ...
    Row(
        ...
        Column(modifier = Modifier.weight(1/3f)) {
            Text(
                text = ComposeString.resource(R.string.janitor_name).value(),
        ...
        Column(
            ...
            Text(
                text = ComposeString.resource(R.string.janitor_number).value(),
                fontFamily = nunitoSans,
                fontWeight = FontWeight.Normal,
                fontSize = 10.sp,
                color = Color(0XFF303972)
